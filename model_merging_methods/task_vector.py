...
class TaskVector:
    def __init__(self, pretrained_model: nn.Module = None, finetuned_model: nn.Module = None, task_vector_param_dict: dict = None):
        """
        ...
        if task_vector_param_dict is not None:
            ...
            # only merge when requiring grad
            for param_name in pretrained_param_dict:
                if pretrained_param_dict[param_name].requires_grad:
